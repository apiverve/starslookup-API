# Stars Lookup API - Examples

This folder contains example code for using the Stars Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/starslookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/starslookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/starslookup](https://docs.apiverve.com/ref/starslookup)
